...
Future-proof your WooCommerce shop for digital payments and checkouts in cryptocurrencies and stablecoins like EURC and USDC. Powered by Whalestack, formerly knows as COINQVEST.
...
2. Merchant dashboard for multi-currency blockchain wallets
3. Automated invoice generation for every payment
4. Payouts to bank accounts (SEPA, SWIFT) and crypto wallets

== Changelog ==

= 2.0.2 =

* Further rebranding-related changes
